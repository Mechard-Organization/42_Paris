...
char	*Dblonchar(t_printf *tab, char *str)
{
	...
	if (tab->eE < 0 && tab->eE > -10000000)
	{
		str[tab->i++] = '-';
		tab->eE *= -1;
	}
	if (tab->eE < 10 && tab->eE >= 0)
		str[tab->i++] = tab->eE + 48;
	else if (tab->eE >= 10)
	{
		e = tab->eE;
	...
	pwr[e] = tab->f;
	e += 1;
	if (tab->c >= 0 && tab->c < 309)
		pwr[e++] = '+';
	else if (tab->c < 0 && tab->c > -309)
		pwr[e++] = '-';
	if(tab->c < 10 && tab->c > -10)
		pwr[e++] = '0';
	i = 0;
	while (tab->ret[i] != '\0')
		tab->ret[i++] = '\0';
...
void	Dbl(t_printf *tab)
{
	...
	if (tab->e < 1 && tab->e > -1)
		while (tab->e < 1000000 && tab->e > -1000000 && pwr-- > -309)
			tab->e = tab->e * 10;
	tab->eE = tab->e;
	if (((tab->e * 10) - (tab->eE * 10)) > 5)
		tab->eE += 1;
	if (((tab->e * 10) - (tab->eE * 10)) < -5)
		tab->eE -= 1;
	while((tab->e >= 10 || tab->e <= -10) && pwr++ > -309)
		tab->e = tab->e / 10;
	if (tab->eE < 0 && tab->eE > -1000000 && sgn++ == 0)
		tab->eE = tab->eE * -1;
	while (tab->eE < 1000000 && tab->eE > 0)
		tab->eE = tab->eE * 10;
	if(sgn == 1)
		tab->eE = tab->eE * -1;
	tab->c = pwr;
